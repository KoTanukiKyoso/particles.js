...
var pJS = function (tag_id, params) {
    ...
    pJS.tmp.obj = {
        rotate_value: pJS.particles.rotate.value,//add
        rotate_anim_speed: pJS.particles.rotate.anim.speed,//add
    ...
    pJS.fn.retinaInit = function () {
        ...
        pJS.particles.rotate.value = pJS.tmp.obj.rotate_value * pJS.canvas.pxratio;//add
        pJS.particles.rotate.anim.speed = pJS.tmp.obj.rotate_anim_speed * pJS.canvas.pxratio;//add
    ...
    pJS.fn.particle.prototype.draw = function () {
        ...
        //add
        if (p.color.rgb) {
            var color_value = 'rgba(' + p.color.rgb.r + ',' + p.color.rgb.g + ',' + p.color.rgb.b + ')';
        } else {
            var color_value = 'hsla(' + p.color.hsl.h + ',' + p.color.hsl.s + '%,' + p.color.hsl.l + '%)';
        }
